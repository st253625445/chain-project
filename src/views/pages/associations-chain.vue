  ...
  <div class="associationChainPage">
    ...
    <div class="itemBox associationChainListBox">
      <p class="title">
        {{ associationName }}
        <span class="subTitle"
          >协会成员 <span class="blueSpan">5</span>名
        </span>
      </p>
      <div class="tableBox">
        <el-table
        ...
        >
          ...
          <el-table-column prop="data2" label="会员类型"> </el-table-column>
          <el-table-column prop="data3" label="产业链板块"> </el-table-column>
