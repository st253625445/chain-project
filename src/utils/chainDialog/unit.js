 ...
 * @Last Modified time: 2019-05-24 18:43:56
 */
...
function DrawTextInRect(
  ...
  let _text =
    text.length > textnum ? text.substring(0, textnum - 1) + "..." : text;
...
export { DrawRoundRect, DrawTextInRect, DrawProbeIcon, IsPointInPath };
